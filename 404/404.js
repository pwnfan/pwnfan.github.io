;(function() {
  ...
  window.addEventListener("page:loaded", function () {
    ...
    invaderAsset.src =
      "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' id='body_1' width='20' height='20'><g transform='matrix(1.3333334 0 0 1.3333334 0 0)'><image  x='0' y='0' xlink:href='data:image/png;base64,' preserveAspectRatio='none' width='15' height='15'/></g></svg>";
  });
